...
const About = () => {
  ...
  return (
    <div>
      <Head>
        <title>Wellcome to - MyApp</title>
        <meta name="description" content="Learn more about MyApp and our mission." />
      </Head>
      <div className="w-full absolute top-0">
        <Navbar />
      </div>
      <main className="h-screen bg-[#f5f5f5] dark:bg-[#000000] pt-2 px-5 flex
        justify-cente items-center">
        <section className="container w-10/12 mx-auto max-w-3xl bg-violet-300 dark:bg-[#f5f5f515] p-5 md:p-8 rounded-lg
          shadow-lg mt-4 flex flex-col md:mt-12 ">
          <div className={`div1 ${isClient ? 'animate-slide-from-left' : ''} p-2 md:mt-2`}>
            <h1 className="text-lg md:text-3xl font-bold mb-2 md:mb-4
